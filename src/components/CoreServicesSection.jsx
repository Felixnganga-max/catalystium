  ...
  return (
    <div className="relative bg-white overflow-hidden">
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-10 right-0 w-96 h-96 bg-blue-700/5 rounded-full blur-3xl" />
        <div className="absolute bottom-10 left-0 w-80 h-80 bg-[#f86f17]/5 rounded-full blur-3xl" />
      </div>
      ...
      <section className="py-12 md:py-16 px-6 md:px-12 relative">
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="text-center mb-10">
            ...
            <h2 className="text-3xl md:text-5xl font-light text-[#151412] tracking-tight mb-3 leading-tight">
            ...
            {services.map((service) => {
              ...
              return (
                <div key={service.id} className="group relative">
                  ...
                  />
                  <div className="relative h-full bg-[#efe7df] rounded-2xl p-7 border border-[#d4c4b4] group-hover:border-blue-700/30 transition-all">
                    <div
                      className={`w-14 h-14 rounded-xl ${
                        service.color === "orange"
                          ? "bg-[#f86f17]"
                          : "bg-blue-700"
                      } flex items-center justify-center mb-5 group-hover:scale-110 transition-transform shadow-lg`}
                    >
                      <Icon className="w-6 h-6 text-white" strokeWidth={2} />
                    </div>

                    <h3 className="text-xl font-semibold text-[#151412] mb-2">
                      {service.title}
                    </h3>
                    ...
                    <p className="text-sm text-[#6e6a64] leading-relaxed mb-5">
                      {service.description}
                    </p>
              ...
              {services.map((service) => {
                ...
                return (
                  <div key={service.id} className="w-72 flex-shrink-0">
                    <div className="relative h-full bg-[#efe7df] rounded-2xl p-6 border border-[#d4c4b4]">
                      <div
                        className={`w-14 h-14 rounded-xl ${
                          service.color === "orange"
                            ? "bg-[#f86f17]"
          ...
          <div className="text-center">
            <a
              href="/services"
              className="inline-flex items-center gap-3 bg-blue-700 text-white px-8 py-3.5 rounded-full font-medium text-sm tracking-wide hover:bg-blue-800 transition-all shadow-lg shadow-blue-700/20 hover:shadow-xl hover:shadow-blue-700/30"
            >
      ...
      <div className="relative h-px bg-[#efe7df]">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex items-center gap-2">
          <div className="w-12 h-px bg-blue-700/20" />
